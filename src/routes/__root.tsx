...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SafeSpace — Ruang Aman & Karakter Positif di Sekolahmu" },
      { property: "og:description", content: "SafeSpace — Bangun ruang aman dan karakter positif di sekolahmu. Edukasi, komunitas, dan dukungan emosional untuk remaja." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "SafeSpace — Ruang Aman & Karakter Positif di Sekolahmu" },
      { name: "twitter:description", content: "SafeSpace — Bangun ruang aman dan karakter positif di sekolahmu. Edukasi, komunitas, dan dukungan emosional untuk remaja." },
